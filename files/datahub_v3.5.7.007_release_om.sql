...
CREATE TABLE `mds_org_ethics` (
  ...
  `project_approval_time` VARCHAR(256) NULL COMMENT '立项时所需时间/时限，用户自定义',
  `ethics_meeting_rate` VARCHAR(256) NULL  COMMENT '伦理会频率，用户自定义',
  `ethics_approval_time` VARCHAR(256) NULL COMMENT '伦理批件获得时间/时限，用户自定义',
  `gos_approval_time` VARCHAR(256) NULL COMMENT '遗传办承诺书获得时间/时限，用户自定义',
  `contact_sign_time` VARCHAR(256) NULL COMMENT '合同签署时限，用户自定义',
